...
.PHONY: build
build:
	go build -o $(BUILD_DIR)/bin/generator github.com/VoIdemar/golang-interview.git/cmd/generator
	go build -o $(BUILD_DIR)/bin/loader github.com/VoIdemar/golang-interview.git/cmd/loader
